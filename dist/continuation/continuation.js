...
export function isLegalContinuationTransition(from, to) {
    return legalTransitions[from].includes(to);
}
export function validateContinuationReceipt(value) {
    ...
    if (receipt.continuation_status === 'complete' &&
