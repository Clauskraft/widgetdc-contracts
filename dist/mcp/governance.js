...
export const GovernanceStandingApproval = Type.Object({
    ...
    description: 'Standing approval block for scheduled internal governed mutation. ' +
...
export const MCPToolGovernance = Type.Object({
    ...
    requires_plan: Type.Boolean({
        description: 'If true, the gate rejects direct execution and routes through HyperAgent ' +
            '(create_plan → approve_plan → execute_plan → evaluate_plan).',
    }),
    requires_approval: Type.Boolean({
        description: 'If true, plan creation alone is insufficient — operator OR policy-profile ' +
    ...
    description: 'Governance metadata declared on every MCP tool definition. The gate ' +
...
export const GovernanceContext = Type.Object({
    ...
    description: 'Server-trusted execution context. Carries actor identity, correlation, ' +
...
export const GovernanceDecision = Type.Object({
    ...
    description: 'Decision returned by the gate. allowed=true means proceed; allowed=false ' +
...
export const GovernanceRejectionNextStep = Type.Object({
    ...
    description: 'Action-oriented next-step instruction returned with every rejection so ' +
...
export const GovernanceRejectionEnvelope = Type.Object({
    ...
    description: 'HTTP 403 body returned by the universal gate when a call is rejected. ' +
...
export const GraphPromotionRequest = Type.Object({
    ...
    description: 'Typed request a HyperAgent plan submits to a governed promotion tool. ' +
