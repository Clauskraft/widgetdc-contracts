...
export const EXECUTION_ENVELOPE_SCHEMA_ID =
  'https://contracts.widgetdc.dev/execution/execution-envelope.schema.json' as const
...
export const AdapterRole = Type.Union(
  [Type.Literal('candidate_writer'), Type.Literal('specialist'), Type.Literal('verifier')],
  { $id: 'AdapterRole' },
)
