...
export const AcceptanceGate = Type.Object({
  id: Type.String({ minLength: 1, description: 'Stable AcceptanceGate identifier.' }),
  ...
  $id: 'AcceptanceGate',
  description: 'AcceptanceGate contract for governed Demand-to-Proof candidate processing.',
