/**
 * DemandObject — Demand-to-Proof contract authority surface.
 *
...
export const DemandObject = Type.Object({
  id: Type.String({ minLength: 1, description: 'Stable DemandObject identifier.' }),
  ...
  $id: 'DemandObject',
  description: 'DemandObject contract for governed Demand-to-Proof candidate processing.',
  additionalProperties: true,
})

export type DemandObject = Static<typeof DemandObject>
