/**
 * CodeElementCandidate — Demand-to-Proof contract authority surface.
 *
...
export const CodeElementCandidate = Type.Object({
  id: Type.String({ minLength: 1, description: 'Stable CodeElementCandidate identifier.' }),
  ...
  $id: 'CodeElementCandidate',
  description: 'CodeElementCandidate contract for governed Demand-to-Proof candidate processing.',
  additionalProperties: true,
})

export type CodeElementCandidate = Static<typeof CodeElementCandidate>
