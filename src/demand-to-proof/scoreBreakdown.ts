/**
 * ScoreBreakdown — Demand-to-Proof contract authority surface.
 *
...
export const ScoreBreakdown = Type.Object({
  id: Type.String({ minLength: 1, description: 'Stable ScoreBreakdown identifier.' }),
  ...
  $id: 'ScoreBreakdown',
  description: 'ScoreBreakdown contract for governed Demand-to-Proof candidate processing.',
  additionalProperties: true,
})

export type ScoreBreakdown = Static<typeof ScoreBreakdown>
