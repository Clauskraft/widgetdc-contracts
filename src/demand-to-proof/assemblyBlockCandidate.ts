/**
 * AssemblyBlockCandidate — Demand-to-Proof contract authority surface.
 *
...
export const AssemblyBlockCandidate = Type.Object({
  id: Type.String({ minLength: 1, description: 'Stable AssemblyBlockCandidate identifier.' }),
  ...
  $id: 'AssemblyBlockCandidate',
  description: 'AssemblyBlockCandidate contract for governed Demand-to-Proof candidate processing.',
  additionalProperties: true,
})

export type AssemblyBlockCandidate = Static<typeof AssemblyBlockCandidate>
