/**
 * ProofRadarBoundary — Demand-to-Proof contract authority surface.
 *
...
export const ProofRadarBoundary = Type.Object({
  id: Type.String({ minLength: 1, description: 'Stable ProofRadarBoundary identifier.' }),
  ...
  $id: 'ProofRadarBoundary',
  description: 'ProofRadarBoundary contract for governed Demand-to-Proof candidate processing.',
  additionalProperties: true,
})

export type ProofRadarBoundary = Static<typeof ProofRadarBoundary>
