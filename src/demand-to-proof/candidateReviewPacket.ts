/**
 * CandidateReviewPacket — Demand-to-Proof contract authority surface.
 *
...
export const CandidateReviewPacket = Type.Object({
  id: Type.String({ minLength: 1, description: 'Stable CandidateReviewPacket identifier.' }),
  ...
  $id: 'CandidateReviewPacket',
  description: 'CandidateReviewPacket contract for governed Demand-to-Proof candidate processing.',
  additionalProperties: true,
})

export type CandidateReviewPacket = Static<typeof CandidateReviewPacket>
