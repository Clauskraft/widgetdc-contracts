/**
 * SourceFitScore — Demand-to-Proof contract authority surface.
 *
...
export const SourceFitScore = Type.Object({
  id: Type.String({ minLength: 1, description: 'Stable SourceFitScore identifier.' }),
  ...
  $id: 'SourceFitScore',
  description: 'SourceFitScore contract for governed Demand-to-Proof candidate processing.',
  additionalProperties: true,
})

export type SourceFitScore = Static<typeof SourceFitScore>
