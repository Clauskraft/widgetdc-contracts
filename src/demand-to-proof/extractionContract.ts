/**
 * ExtractionContract — Demand-to-Proof contract authority surface.
 *
...
export const ExtractionContract = Type.Object({
  id: Type.String({ minLength: 1, description: 'Stable ExtractionContract identifier.' }),
  ...
  $id: 'ExtractionContract',
  description: 'ExtractionContract contract for governed Demand-to-Proof candidate processing.',
  additionalProperties: true,
})

export type ExtractionContract = Static<typeof ExtractionContract>
