/**
 * OSINTSignalCandidate — Demand-to-Proof contract authority surface.
 *
...
export const OSINTSignalCandidate = Type.Object({
  id: Type.String({ minLength: 1, description: 'Stable OSINTSignalCandidate identifier.' }),
  ...
  $id: 'OSINTSignalCandidate',
  description: 'OSINTSignalCandidate contract for governed Demand-to-Proof candidate processing.',
  additionalProperties: true,
})

export type OSINTSignalCandidate = Static<typeof OSINTSignalCandidate>
