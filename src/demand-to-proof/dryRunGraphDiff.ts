/**
 * DryRunGraphDiff — Demand-to-Proof contract authority surface.
 *
...
export const DryRunGraphDiff = Type.Object({
  id: Type.String({ minLength: 1, description: 'Stable DryRunGraphDiff identifier.' }),
  ...
  $id: 'DryRunGraphDiff',
  description: 'DryRunGraphDiff contract for governed Demand-to-Proof candidate processing.',
  additionalProperties: true,
})

export type DryRunGraphDiff = Static<typeof DryRunGraphDiff>
