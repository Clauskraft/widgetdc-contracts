/**
 * MappingCandidate — Demand-to-Proof contract authority surface.
 *
...
export const MappingCandidate = Type.Object({
  id: Type.String({ minLength: 1, description: 'Stable MappingCandidate identifier.' }),
  ...
  $id: 'MappingCandidate',
  description: 'MappingCandidate contract for governed Demand-to-Proof candidate processing.',
  additionalProperties: true,
})

export type MappingCandidate = Static<typeof MappingCandidate>
