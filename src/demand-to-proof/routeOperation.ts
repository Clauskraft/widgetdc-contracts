/**
 * RouteOperation — Demand-to-Proof contract authority surface.
 *
...
export const RouteOperation = Type.Object({
  id: Type.String({ minLength: 1, description: 'Stable RouteOperation identifier.' }),
  ...
  $id: 'RouteOperation',
  description: 'RouteOperation contract for governed Demand-to-Proof candidate processing.',
  additionalProperties: true,
})

export type RouteOperation = Static<typeof RouteOperation>
