...
class AliasResolutionResultV15(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    schema_version: Literal['wdc.alias_resolution_result.v1']
...
class AliasResolutionResultV14(BaseModel):
    ...
    status: Literal['unresolved']
    reason: Literal['version_incompatible']
    matched_capability_id: CapabilityIdentifierV1
    requested_version_token: str = Field(..., pattern='^v[1-9][0-9]*$')
