...
async function buildComplianceMatrix(options: ComplianceMatrixOptions) {
  ...
  const rows: ComplianceMatrixRow[] = [
    ...
    },
    {
      ...
      severity_score: 4,
      trend: "up",
      evidence: { source: "apps/backend/src/bootstrap/newServiceMcpRegistration.ts", check: "Resilient per-tool dynamic imports with individual try/catch (PR #3883)" },
      remediation: { action: "Monitor tool registration count in /api/mcp/status.", owner: "backend", target_date: "2026-03-31" },
      audit: { updated_by: "omega-sentinel", updated_at: auditNow, note: "5 tools register independently 2026-03-23" },
    },
    {
      id: "route-mcp-status",
      ...
      severity_score: 3,
      trend: "up",
      evidence: { source: "apps/backend/src/mcp/mcpRouter.ts", check: "request_id added to metadata for compliance parity (PR #3883)" },
      remediation: { action: "Monitor envelope compliance with audit.run.", owner: "backend", target_date: "2026-03-31" },
      audit: { updated_by: "omega-sentinel", updated_at: auditNow, note: "status envelope complete 2026-03-23" },
    },
    {
      id: "route-rlm-health",
      ...
      severity_score: 4,
      trend: "up",
      evidence: { source: "src/routes/health.py", check: "GET /healthz + /health with canonical envelope (PR #57)" },
      remediation: { action: "Monitor /healthz availability via Railway healthcheck.", owner: "rlm", target_date: "2026-03-20" },
      audit: { updated_by: "omega-sentinel", updated_at: auditNow, note: "/healthz deployed 2026-03-24" },
    },
    {
      id: "route-rlm-errors",
      ...
      severity_score: 4,
      trend: "up",
      evidence: { source: "src/routes/errors.py", check: "GET /errors + /errors/stats with ring buffer and canonical envelope (PR #57)" },
      remediation: { action: "Monitor error buffer utilization.", owner: "rlm", target_date: "2026-03-25" },
      audit: { updated_by: "omega-sentinel", updated_at: auditNow, note: "/errors endpoint deployed 2026-03-24" },
    },
    {
      ...
      severity_score: 5,
      trend: "up",
      evidence: { source: "src/routes/cortex_reasoning.py", check: "GET /cognitive/map exposes subsystem graph + pipeline DAG (PR #57)" },
      remediation: { action: "Extend cognitive map with real-time state transitions.", owner: "rlm", target_date: "2026-04-05" },
      audit: { updated_by: "omega-sentinel", updated_at: auditNow, note: "/cognitive/map deployed 2026-03-24, 8 nodes active" },
    },
    {
    ...
    },
    {
      ...
      severity_score: 2,
      trend: "up",
      evidence: { source: "scripts/arch-mcp-server.ts", check: "Canonical {success,data,metadata} envelope + ?raw=true fallback (PR #13)" },
      remediation: { action: "Maintain envelope contract. Deprecate ?raw=true after consumer migration.", owner: "contracts", target_date: "2026-04-15" },
      audit: { updated_by: "omega-sentinel", updated_at: auditNow, note: "envelope + consumer migration complete 2026-03-24" },
    },
    {
    ...
    },
    {
      ...
      severity_score: 4,
      trend: "up",
      evidence: { source: "src/cron-output-validator.js", check: "Runtime contract validator with fallback schemas (PR #11)" },
      remediation: { action: "Monitor validation rejection rate in slack notifications.", owner: "automation", target_date: "2026-04-01" },
      audit: { updated_by: "omega-sentinel", updated_at: auditNow, note: "cron-output-validator.js deployed 2026-03-23" },
    },
    {
    ...
    },
    {
      ...
      severity_score: 3,
      trend: "up",
      evidence: { source: "src/memory-schema.js", check: "Schema v2 with sequential migration + validateSnapshot (PR #11)" },
      remediation: { action: "Monitor migration_applied_at for schema drift.", owner: "automation", target_date: "2026-04-02" },
      audit: { updated_by: "omega-sentinel", updated_at: auditNow, note: "memory-schema.js deployed 2026-03-23" },
    },
    {
    ...
    },
    {
      ...
      severity_score: 4,
      trend: "up",
      evidence: { source: "apps/backend/src/routes/cortex.ts", check: "validateCortexEvent + stampContract on all endpoints (PR #3905)" },
      remediation: { action: "Extend contract validation to legacy cortex.routes.js.", owner: "backend", target_date: "2026-04-05" },
      audit: { updated_by: "omega-sentinel", updated_at: auditNow, note: "contract validators deployed 2026-03-24" },
    },
